        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0"  class="tabForm" id="tax_settings">
            ...
            {foreach from=$row item=rrow}
                ...
                <tr>
                    ...
                    <td valign="top" >
                        <input type="text" name="tax_rate[]" id="tax_rate{$i}" required value="{if !empty($rrow.tax_rate)}{$rrow.tax_rate}{else}0{/if}" size="5">%
                    </td>
                    <td valign="top" >
                        Salary From:  <input type="text" name="sal_from[]" id="sal_from{$i}" required value="{if !empty($rrow.sal_from)}{$rrow.sal_from}{else}0{/if}">
                    </td>
                    <td valign="top" >
