...
class AccountsTotalDashlet extends DashletGenericChart

{
    ...
    {
        require('custom/modules/Accounts/Dashlets/AccountsTotalDashlet/AccountsTotalDashlet.data.php');
        global $timedate;
        ...
        $this->_searchFields = $dashletData['AccountsTotalDashlet']['searchFields'];
