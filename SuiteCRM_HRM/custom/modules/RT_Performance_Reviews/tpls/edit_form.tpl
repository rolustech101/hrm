                            ...
                            {if $v.type == 'mutliple_choice'}
                                ...
                                {if isset($v.options)}
                                    {foreach from=$v.options key=k1 item=v1}
                                        <tr id="mop{$mmval}" class="muti-options{$val}"><td><table id="option_table"><tr><td width="12.5%" valign="top" scope="row">Option Label: </td><td width="33.5%" valign="top" colspan="3"><input type="text" name="label_question{$val}_option[]" id="label_option" value="{$v1}"></td></tr><tr><td><input type="button" onclick="removeTr('mop{$mmval}');" id="remove_tr" value="Remove option"></td></tr></table></td></tr>
                                ...
                                {/if}
                                {else}
                                <tr id="tr{$val}"><td><table><tr><td width="12.5%" valign="top" scope="row">Question: </td><td width="33.5%" valign="top" colspan="3"><input type="text" name="label_question{$val}" id="label_question{$val}" value="{$v.question}" required></td></tr><tr><td width="12.5%" valign="top" scope="row">Question Type: </td><td width="33.5%" valign="top" colspan="3"> <input type="checkbox" name="question_type{$val}" id="{$val}" value="text_area"  class="taOpt text_area{$val}" checked = "checked"> TextArea <input type="checkbox" name="question_type{$val}" id="{$val}" value="mutliple_choice" class="mcOpt muti_choice{$val}" > Multiple Choice </td></tr><tr><td><input type="button" onclick="removeQuestion('tr{$val}');" id="remove_question" value="Remove"></td></tr></table></td></tr>
                            {/if}
