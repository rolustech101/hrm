                    ...
                    <table id="salary_table">
                        ...
                        {foreach from=$form_meta key=k item=v}
                            {if $v.type == 'mutliple_choice'}
                                <tr id="{$val}"><td><table><tr><td width="12.5%" valign="top" scope="row">Question: </td><td width="33.5%" valign="top" colspan="3"><input type="text" name="label_question{$val}" id="label_question{$val}" value="{$v.question}" required></td></tr><tr><td width="12.5%" valign="top" scope="row">Question Type: </td><td width="33.5%" valign="top" colspan="3"> <input type="checkbox" name="question_type{$val}" id="{$val}" value="text_area"  class="taOpt text_area{$val}" > TextArea <input type="checkbox" name="question_type{$val}" id="{$val}" value="mutliple_choice" class="mcOpt muti_choice{$val}" checked = "checked"> Multiple Choice </td></tr>
                                {if isset($v.options)}
