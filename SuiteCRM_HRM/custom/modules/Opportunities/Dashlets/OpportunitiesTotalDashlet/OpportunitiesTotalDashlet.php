...
class OpportunitiesTotalDashlet extends DashletGenericChart
...
//                require('custom/modules/Opportunities/Dashlets/OpportunitiesTotalDashlet/OpportunitiesTotalDashlet.data.php');
//        $this->_searchFields = $dashletData['OpportunitiesTotalDashlet']['searchFields'];
//
//    }
//
//    /**
...
//            translate('LBL_OPP_SIZE', 'Charts') . ' ' . $currency_symbol . '1' .translate('LBL_OPP_THOUSANDS', 'Charts'),
 $sugarChart->setProperties("$this->name",'subtitle', $chartDef['chartType']);
        ...
        $GLOBALS['log']->fatal('oppertunity data set !!!!!');
        $GLOBALS['log']->fatal($sugarChart->data_set);
        $xmlFile = $sugarChart->getXMLFileName($this->id);
        $GLOBALS['log']->fatal('XML FILE OPERTUNITY !!!!!!');
