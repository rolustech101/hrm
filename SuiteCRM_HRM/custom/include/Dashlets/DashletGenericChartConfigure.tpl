...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="edit view">
    ...
    <tr>
	    <td colspan='4' align='right'>
	        ...
	        {if $showClearButton}
	        <input type='submit' class='button' id = 'my_save_btn' value='{$clear}' onclick='SUGAR.searchForm.clear_form(this.form,["dashletTitle","autoRefresh"]);return false;'>
	        {/if}
        </td>    
	</tr>
</table>
...
<script src="custom/include/Dashlets/func.js"></script>
