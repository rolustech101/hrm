 ...
 * PLACE ANY CUSTOMIZATIONS IN RT_Candidates
 */

require_once('include/SugarObjects/templates/person/Person.php');

class RT_Candidates_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'RT_Candidates';
	var $object_name = 'RT_Candidates';
	var $table_name = 'rt_candidates';
