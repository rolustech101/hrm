...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `fn_autoincrementvalue`(`pTableName` VARCHAR(50)) RETURNS int(11)
BEGIN
RETURN( SELECT AUTO_INCREMENT FROM information_schema.`TABLES` WHERE TABLE_NAME = pTableName LIMIT 1 );
END$$
...
CREATE TABLE IF NOT EXISTS `rt_candidates` (
  ...
  `currently_employed` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `rt_employees` (
  ...
  `rtemployee_id` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rt_job_application` (
  `id` char(36) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `date_entered` datetime DEFAULT NULL,
  `date_modified` datetime DEFAULT NULL,
  ...
  `parent_id` char(36) DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `job_application_number` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `rt_job_application_audit`
--

CREATE TABLE IF NOT EXISTS `rt_job_application_audit` (
  `id` char(36) NOT NULL,
  `parent_id` char(36) NOT NULL,
  `date_created` datetime DEFAULT NULL,
  `created_by` varchar(36) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rt_salarysetting` (
  ...
  `country` varchar(255) DEFAULT NULL,
  `filling_status` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `rt_vacancies`
--

CREATE TABLE IF NOT EXISTS `rt_vacancies` (
  `id` char(36) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `date_entered` datetime DEFAULT NULL,
  `date_modified` datetime DEFAULT NULL,
  ...
  `deleted` tinyint(1) DEFAULT '0',
  `assigned_user_id` char(36) DEFAULT NULL,
  `financial_area` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `rt_vacancies_audit`
--

CREATE TABLE IF NOT EXISTS `rt_vacancies_audit` (
  `id` char(36) NOT NULL,
  `parent_id` char(36) NOT NULL,
  `date_created` datetime DEFAULT NULL,
  `created_by` varchar(36) DEFAULT NULL,
  ...
  `after_value_text` text,
  PRIMARY KEY (`id`),
  KEY `idx_rt_vacancies_parent_id` (`parent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `rt_vacancies_cstm`
--

CREATE TABLE IF NOT EXISTS `rt_vacancies_cstm` (
  `id_c` char(36) NOT NULL,
  `department_c` varchar(255) DEFAULT NULL,
  `positions_c` int(255) DEFAULT NULL,
